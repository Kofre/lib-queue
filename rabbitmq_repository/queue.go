...
func (q *Queue) StartConsume(consumeHandler queue_interface.FnConsume) error {
...
func (q *Queue) treatMessage(message amqp.Delivery, consumeHandler queue_interface.FnConsume) {
